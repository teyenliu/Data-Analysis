...
class StockerTWDF():
    ...
    def __init__(self, ticker, csv_file):
        
        # Symbol is used for labeling plots
        self.symbol = "tw_" + ticker

        if isinstance(csv_file, str):
            stock_data = pd.read_csv(csv_file, header=0, sep='\t', encoding = 'utf-8')
    ...
    def prepareParameters(self, stock_data):
